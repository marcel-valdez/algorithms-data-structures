...
class Section1Exercises_test < TestHelper
  ...
  # Write a method that takes an array 'a' of number values and number M as arguments and returns an array 'b' of length M whose b[i] us the number of times the integer i appeared in the argument array. If the values in a[] are all between 0 and M-1, the sume of the values in the returned array should be equal to a.length
  ...
  # 1.1.22 Write a version of BinarySearch that uses the recursive rank() given on page 25 and traces the method calls. Each time the 
  ...
  # 1.1.24 Write a method that calculates the greatest common divisor, using Euclid's algorithm and
  ...
  # 1.1.27 Create a function that estimates the number of recursive calls of binomial
  ...
  # 1.1.28 Write a function that removes duplicates from an array
